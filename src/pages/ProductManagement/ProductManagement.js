          ...
          <DashboardWrapper>
            <DashboardHeading>
              ...
              <ArrowBackIosIcon
                ...
                />
                <DashHeading>Products</DashHeading>
              </MenuAndBack>
                  ...
                  <TableBody>
                    {recordsAfterPagingAndSorting().map((category, index) => (
                      <TableRow key={category._id}>
                        ...
                        <TableCell className={classes.textMiddle}>
                          <div>{get(category, "category.name", "N/A")}</div>
                        </TableCell>
                        <TableCell className={classes.textMiddle} style={{ textTransform: "capitalize" }}>
                          <div>
                         
                            {get(category, "subcategory.name", "N/A")}
                          </div>
                        </TableCell>
                        <TableCell className={classes.textMiddle}>
                          <div>{get(category, "item", "N/A")}</div>
                        </TableCell>
                     
                        <TableCell className={classes.textMiddle}>
                          <div>
                            {get(category, "price", "N/A")} 
                          </div>
                        </TableCell>
                        <TableCell className={classes.textMiddle}>
                          <div>
