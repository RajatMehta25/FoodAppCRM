...
const OfferManagement = ({ history, setUsers, userData, }) => {
    ...
    const getSubscriptions = async () => {
        try {
            const { data } = await axios.get("/admin/subscription-plan");
                                        ...
                                        <Table stickyHeader>
                                            <TableHead>
                                                <TableRow>
                                                    ...
                                                    <TableCell className={classes.tablePadding}>Plan Type</TableCell>
                                            ...
                                            <TableBody>
                                                {recordsAfterPagingAndSorting().map((category, index) => (
                                                    <TableRow key={category._id}>
                                                        ...
                                                        <TableCell className={classes.textMiddle}>
                                                            <div>
                                                           { subscriptionType(category.type)}
                                                            </div>
                                                        </TableCell>
                                                        <TableCell className={classes.textMiddle}>
                                                            <div>
                                                        ...
                                                        <div>
                                                        <input 
                                                        onChange={() => blockUnblockSubscription(category._id, category.is_enabled)}
                                                        ...
                                                        <SvgLogo
                                                                ...
                                                                onClick={() => {
                                                                    setBranchFormValues({
                                                                        ...
                                                                        name: category.name,
                                                                        feature1: category.features[0],
                                                                        feature2: category.features[1],
                                                                        feature3: category.features[2],
